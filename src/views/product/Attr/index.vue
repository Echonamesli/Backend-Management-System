     ...
     <div v-show="!isShowTable">
      <el-form :inline="true" ref="form">
        <el-form-item label="属性名">
            <el-input placeholder="请输入属性名" label-width="80px"></el-input>
        </el-form-item>
      </el-form>
      <el-button icon="el-icon-plus" type="primary"  :disabled="true" @click="isShowTable=false">添加属性值</el-button>
       <el-button>取消</el-button>
       <el-table :data="attrList" style="width: 100%; margin: 20px 0px" border>
        <el-table-column type="index" label="序号" width="80" align="center"></el-table-column>
